(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();var Kp={exports:{}},_l={},Zp={exports:{}},ze={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,q){var Z=D.length;D.push(q);e:for(;0<Z;){var le=Z-1>>>1,Te=D[le];if(0<r(Te,q))D[le]=q,D[Z]=Te,Z=le;else break e}}function n(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var q=D[0],Z=D.pop();if(Z!==q){D[0]=Z;e:for(var le=0,Te=D.length,Ze=Te>>>1;le<Ze;){var je=2*(le+1)-1,Ge=D[je],X=je+1,Q=D[X];if(0>r(Ge,Z))X<Te&&0>r(Q,Ge)?(D[le]=Q,D[X]=Z,le=X):(D[le]=Ge,D[je]=Z,le=je);else if(X<Te&&0>r(Q,Z))D[le]=Q,D[X]=Z,le=X;else break e}}return q}function r(D,q){var Z=D.sortIndex-q.sortIndex;return Z!==0?Z:D.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],d=1,f=null,h=3,p=!1,v=!1,y=!1,m=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(D){for(var q=n(c);q!==null;){if(q.callback===null)i(c);else if(q.startTime<=D)i(c),q.sortIndex=q.expirationTime,e(l,q);else break;q=n(c)}}function x(D){if(y=!1,_(D),!v)if(n(l)!==null)v=!0,j(w);else{var q=n(c);q!==null&&J(x,q.startTime-D)}}function w(D,q){v=!1,y&&(y=!1,u(b),b=-1),p=!0;var Z=h;try{for(_(q),f=n(l);f!==null&&(!(f.expirationTime>q)||D&&!L());){var le=f.callback;if(typeof le=="function"){f.callback=null,h=f.priorityLevel;var Te=le(f.expirationTime<=q);q=t.unstable_now(),typeof Te=="function"?f.callback=Te:f===n(l)&&i(l),_(q)}else i(l);f=n(l)}if(f!==null)var Ze=!0;else{var je=n(c);je!==null&&J(x,je.startTime-q),Ze=!1}return Ze}finally{f=null,h=Z,p=!1}}var A=!1,R=null,b=-1,T=5,M=-1;function L(){return!(t.unstable_now()-M<T)}function O(){if(R!==null){var D=t.unstable_now();M=D;var q=!0;try{q=R(!0,D)}finally{q?V():(A=!1,R=null)}}else A=!1}var V;if(typeof g=="function")V=function(){g(O)};else if(typeof MessageChannel<"u"){var $=new MessageChannel,W=$.port2;$.port1.onmessage=O,V=function(){W.postMessage(null)}}else V=function(){m(O,0)};function j(D){R=D,A||(A=!0,V())}function J(D,q){b=m(function(){D(t.unstable_now())},q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,j(w))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(h){case 1:case 2:case 3:var q=3;break;default:q=h}var Z=h;h=q;try{return D()}finally{h=Z}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,q){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var Z=h;h=D;try{return q()}finally{h=Z}},t.unstable_scheduleCallback=function(D,q,Z){var le=t.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?le+Z:le):Z=le,D){case 1:var Te=-1;break;case 2:Te=250;break;case 5:Te=1073741823;break;case 4:Te=1e4;break;default:Te=5e3}return Te=Z+Te,D={id:d++,callback:q,priorityLevel:D,startTime:Z,expirationTime:Te,sortIndex:-1},Z>le?(D.sortIndex=Z,e(c,D),n(l)===null&&D===n(c)&&(y?(u(b),b=-1):y=!0,J(x,Z-le))):(D.sortIndex=Te,e(l,D),v||p||(v=!0,j(w))),D},t.unstable_shouldYield=L,t.unstable_wrapCallback=function(D){var q=h;return function(){var Z=h;h=q;try{return D.apply(this,arguments)}finally{h=Z}}}})(cm);lm.exports=cm;var p_=lm.exports;/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wi,depthTest:!1,depthWrite:!1})}function Lp(){return new $i({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ud(),fragmentShader:`
		...
		`,blending:Wi,depthTest:!1,depthWrite:!1})}function Dp(){return new $i({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ud(),fragmentShader:`
...
`)+`
`+u);const _=g+m+o,x=g+u+a,w=zp(r,r.VERTEX_SHADER,_),A=zp(r,r.FRAGMENT_SHADER,x);r.attachShader(y,w),r.attachShader(y,A),n.index0AttributeName!==void 0?r.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function R(L){if(t.debug.checkShaderErrors){const O=r.getProgramInfoLog(y)||"",V=r.getShaderInfoLog(w)||"",$=r.getShaderInfoLog(A)||"",W=O.trim(),j=V.trim(),J=$.trim();let D=!0,q=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(D=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,y,w,A);else{const Z=Vp(r,w,"vertex"),le=Vp(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
